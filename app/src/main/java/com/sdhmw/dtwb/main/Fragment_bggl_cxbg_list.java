...
public class Fragment_bggl_cxbg_list extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_bggl_cxbg_list, container, false);
    ...
    private void initView(View rootView) {
        //表格
        mLinearLayout = (LinearLayout)rootView.findViewById(R.id.bggl_cxbg_list_LinearLayout);
    }
