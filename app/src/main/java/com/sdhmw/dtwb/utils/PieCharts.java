...
//      mLegend.setForm(LegendForm.LINE);  //设置比例图的形状，默认是方形
     ...
     * @param resources
     */
    public PieData getPieData(int count, float range, Resources resources) {
...
//        DisplayMetrics metrics = getResources().getDisplayMetrics();  //必须在Activity中才可以
        DisplayMetrics metrics = resources.getDisplayMetrics();     //此方法行不通（撇弃）
